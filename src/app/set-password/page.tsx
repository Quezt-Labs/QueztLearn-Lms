...
function SetPasswordContent() {
  ...
  if (isPasswordSet && !isInitializing) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/5 relative overflow-hidden">
