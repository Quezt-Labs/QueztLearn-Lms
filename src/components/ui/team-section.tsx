        ...
        <div className="container grid items-center justify-center gap-8 px-4 text-center md:px-6">
          ...
          <div className="relative z-10 mx-auto grid w-full max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
            {members.map((member, index) => (
              ...
              >
                {/* Background wave animation with theme colors */}
                <div
                ...
                <div className="relative z-10 h-36 w-36 overflow-hidden rounded-full border-4 border-transparent bg-background/20 transition-all duration-500 ease-out group-hover:border-primary group-hover:scale-105">
                  <img
                    src={member.imageSrc}
                    alt={member.name}
