        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="space-y-8 max-w-xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed animate-fade-in-up [animation-delay:400ms]">
              Join thousands of educators who trust QueztLearn for their
              learning management needs. Get started with a 14-day free trial.
            </p>
            <div className="flex flex-wrap gap-4 animate-fade-in-up [animation-delay:600ms]">
              <Link
                href="/create-organization"
                className="group relative px-6 py-3 bg-primary text-primary-foreground rounded-md font-medium overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
